...
Next, navigate to the **test** directory and run ``dotnet test`` to execute the unit test cases.

Check the result of the unit test. You should see the following output from terminal if you haven't implemented all the methods:
