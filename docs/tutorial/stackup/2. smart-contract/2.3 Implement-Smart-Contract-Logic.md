...
This function will be implemented by you all. After completed the implementation, you can scroll to the bottom of the page to check if your implementation matches the reference code.
...
This function will be implemented by you all as well. After completed the implementation, you can scroll to the bottom of the page to check if your implementation matches the reference code.
...
The following are the reference codes for JoinDAO and GetAllProposals. You can check if your implementation matches the reference codes.
