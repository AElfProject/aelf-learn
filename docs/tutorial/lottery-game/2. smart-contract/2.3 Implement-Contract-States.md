...
Open the **src/LotteryGameState.cs** file.
...
Since we will need to reference to the Multitoken System Contract, we shall create a new file to implement the state reference on it.

### Step 2.1: Creating Multitoken Contract proto file

Create the file **src/Protobuf/reference/token_contract.proto**

Import Multitoken Contract's proto file by copy and pasting the below code into **token_contract.proto**.
...
:::tip
The latest `token_contract.proto` can be acquired from [here](https://github.com/AElfProject/AElf/blob/v1.9.0/protobuf/token_contract.proto)
:::

### Step 2.2: Create Contract Reference State

Create a file **src/ContractReferences.cs**
...
We have successfully created a Contract State that references the Multitoken Contract. Next, we will just need to initialize it.