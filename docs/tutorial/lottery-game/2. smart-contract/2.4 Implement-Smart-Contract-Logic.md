...
```
Line 11 shows how you can reference to any contract using the contract address. In this case, we have initialized `TokenContract` and we would then be able to use it to reference the Multitoken Contract in other functions.
